...
export class ChartsComponent implements OnInit, OnDestroy {
  @ViewChild('pieChartContainer', { read: true, static: false })
  _pieChartContainer!: ElementRef;
  echartsIntance: any;

  @ViewChild('realTimeChartWrapper', { read: true, static: false })
  _realTimeChartWrapper!: ElementRef;
  realtimeChartInitOptions: any;
  realtimeChartOptions: any;
  realtimeChartIntance: any;
  realtimeChartUpdate: any;

  @ViewChild('areaSliderChartWrapper', { read: true, static: false })
  _areaSliderChartWrapper!: ElementRef;
  areaSliderChartInitOptions: any;
  areaSliderChartOptions: any;
  areaSliderChartIntance: any;
  areaSliderChartUpdate: any;
  ...
  nvd3LineOptions: any;
  nvd3LineData: any;
  nvd3LineAreaOptions: any;
  nvd3LineAreaData: any;
  data: any;
  optionsPie: any;
  initOptionsPie: any;
  optionsLineStack: any;
  initOptionsLineStack: any;
  ...
  initRealtimeChart() {
    ...
    this.interval = setInterval(
      function () {
        //@ts-ignore
        let updatedOptions = { ...this.realtimeChartOptions };
        let data0 = updatedOptions.series[0].data;
        let data1 = updatedOptions.series[1].data;
        data0.shift();
  ...
  initBarChart() {
    this.barChartTimer = setTimeout(() => {
      this.barChartOptions = {
        chart: {
          type: 'multiBarChart',
          color: [pg.getColor('complete'), pg.getColor('master-light')],
          x: function (d: any) {
            return d[0];
          },
          y: function (d: any) {
  ...
  ngOnInit() {
    this.service = this._service.getChartSampleData().subscribe((d: any) => {
  ...
  // realtime chart
  onRealtimeChartResize(event: any) {
    this.realtimeChartResize();
  }

  onRealtimeChartInit(ec: any) {
  ...
  // area slider
  onAreaSliderChartResize(event: any) {
    this.areaSliderChartResize();
  }

  onAreaSliderChartInit(ec: any) {
